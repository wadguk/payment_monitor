...
@Slf4j
public class LtcScanner extends ScannerPolling {
    public LtcScanner(LtcNetwork network, LastBlockPersister lastBlockPersister, Long pollingInterval, Integer commitmentChainLength) {
