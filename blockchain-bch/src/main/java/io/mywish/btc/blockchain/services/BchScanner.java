...
@Slf4j
public class BchScanner extends ScannerPolling {
    public BchScanner(BchNetwork network, LastBlockPersister lastBlockPersister, Long pollingInterval, Integer commitmentChainLength) {
